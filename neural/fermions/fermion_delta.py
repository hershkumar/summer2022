...
first_step_size = find_step_size(params, 1)

opt_init, opt_update, get_params = jax_opt.adam(10 ** (-2))
resultsa = train(params, 250, 500, 100, 10, first_step_size)

opt_init, opt_update, get_params = jax_opt.adam(10 ** (-3))
resultsb = train(resultsa[3], 500, 800, 100, 10, find_step_size(resultsa[3], first_step_size))

resultsc = train(resultsb[3], 200, 3000, 100, 10, find_step_size(resultsb[3], first_step_size))
...
filename = "fermions_delta_data/fermions_delta_" + str(N_up) + "_" + str(N_down) + ".txt"
