...
step_size = .3
params = load_params("4+4_g_-15.pkl")
g = -1.5

opt_init, opt_update, get_params = jax_opt.adam(10 ** (-4))


resultsa = train(params, 10, 2000, 100, 10, find_step_size(params, .3), g)
resultsb = train(resultsa[3], 500,10000,100,10, find_step_size(resultsa[3],step_size), g)
...
# save the parameters
save_params(resultsd[3], "4+4/4+4_g_-1.5_PRECISE.pkl")