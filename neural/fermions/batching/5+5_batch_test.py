...
samples1 = sample_pmap(params, 2000, 5000, 10, step_size, jax.random.key(int(time.time())))
samples2 = sample_pmap(params, 2000, 5000, 10, step_size, jax.random.key(int(time.time())))
...
resultsa = batch_train(params, 10, 128000, 64, 5000, 10, step_size, g)
...
# resultsa_reg = train(params, 10, 128000, 5000, 10, step_size, g)
